...
def seventhscreen():
    ...
    sevenlabel = Label(SaveMe, text="""*Well you have snakes all around you.(in terms of people as well)
                     How about we play a game of snakes?*
                                         
                     Voice:"Your next QUEST is to feed the snake which is hungry for revenge. 
                     If you touch any part of itself, it goes back to size 0"
                     
                     Aaron: "Is it sort of a snake game."

                     Voice: "Smart guess! Now Goodluck." """, font=("Helvetica", 20), fg="white", bg="#1C1C1E", wraplength=800)
    sevenlabel.place(x=100, y=200) 
    ...
    def snake_game():
        ...
        def end_game():
            ...
            screen.clear()  # Clear the screen to reset
            screen.bgcolor("red")  # Change the background color to signify game over
            screen.title("Game Over")  # Display game over message

            # Display a Game Over message
            pen.goto(0, 0)
            pen.write("Game Over! Click anywhere to exit", align="center", font=("Arial", 24, "normal"))
            turtle.exitonclick()
